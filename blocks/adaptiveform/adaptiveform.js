...
var FormFieldBase = /*#__PURE__*/function (_FormField) {
  ...
  _proto.renderLabel = function renderLabel() {
    return "" + (this.isLabelVisible() ? "<label id=\"" + this.id + "-label\" for=\"" + this.id + "\" class=\"" + this.getbemBlock() + "__label\" >" + this.getLabelValue() + "</label>" : "");
  };
  ...
  _proto.getShortDescHTML = function getShortDescHTML() {
    return "" + (this.isShortDescVisible() ? "<div id=\"" + this.id + "-shortDescription\" class=\"" + this.getbemBlock() + "__shortdescription\">\n                {this.getShortDescValue()}\n            </div>" : "");
  };
  ...
  _proto.getErrorHTML = function getErrorHTML() {
    return "<div id=\"" + this.id + "-errorMessage\" class=\"" + this.getbemBlock() + "__errormessage\"></div>";
  };
...
var decorate = function decorate(block) {
  try {
    var form = block.querySelector('a[href$=".json"]');
    var _temp = function () {
